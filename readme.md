# AI Edge Computing End-Point Intelligent Monitoring Video Detection Authorized

# Body

AI Edge Computing End-Point Intelligent Monitoring Video Detection Authorized AI Edge Computing Intelligent Video Surveillance Platform Compatible with All RuiKe Micro RK3588

AI Intelligent Video Surveillance Platform Source Code】Supports AI intelligent analysis, platform interface is friendly, easy to operate, suitable for project development, learning reference, and actual deployment. Supports local deployment, with functions including real-time monitoring, AI analysis, alarm push notifications, etc., specific functions can be privately chatted about.

Supports facial recognition, passenger and vehicle flow counting, license plate recognition, sound and text detection, sound event detection, human keypoint posture recognition, text recognition, etc. It has integrated NVR capabilities and can be connected to gb28181, supporting bidirectional intercom for edge devices.

The lighting system can be adapted to various scenarios such as kitchens, restaurants, gas stations, industrial parks, ship docks, and campus commercial areas.
